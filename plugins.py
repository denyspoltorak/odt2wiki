...
class Customization:
    ...
    # Set a dictionary of {filename, document.ImageData} filtered from all known images by self.is_useful_image()
    @staticmethod
    def set_extra_images(images):
        assert not images
    ...
    # Is this local image needed for the output even if it is not in the ODT
    @staticmethod
...
class Analytics:  
    def make(self, root, customization = None):
        self._set_root(root)
        self._set_customization(customization)
